# Generated by Django 4.2.1 on 2023-06-07 11:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("nekretnina", "0014_nekretninapagewithform"),
    ]

    operations = [
        migrations.CreateModel(
            name="KontaktFormaFormField",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.DeleteModel(name="NekretninaPageWithForm",),
        migrations.AddField(
            model_name="kontaktformaformfield",
            name="page",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="form_fields",
                to="nekretnina.kontaktformapage",
            ),
        ),
    ]
